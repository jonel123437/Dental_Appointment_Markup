...
document.querySelector('.today-badge').innerHTML = `
  ...
  students.forEach((student, i) => {
    ...
    tbody.innerHTML += `
      <tr>
        ...
        <td data-label="Actions"><button class="action-btn edit" onclick="openEditModal('${fullName}','${student.sid}',${credits})"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg> Edit</button></td>
      </tr>`;
  });
}
...
function loadFeedback() {
  ...
  allFeedback.forEach(({ student, appt }, i) => {
    ...
    if (appt.response === 'yes')       { badgeClass = 'yes';  badgeLabel = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="20 6 9 17 4 12"/></svg> Yes'; }
    else if (appt.response === 'no')   { badgeClass = 'no';   badgeLabel = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><line x1="18" y1="6" x2="6" y2="18"/><line x1="6" y1="6" x2="18" y2="18"/></svg> No'; }
    else if (appt.response === 'auto-yes') { badgeClass = 'auto'; badgeLabel = '<svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round"><polyline points="20 6 9 17 4 12"/></svg> Auto-Yes'; }
    ...
    tbody.innerHTML += `
      <tr>
        ...
        <td data-label="Actions"><button class="action-btn" onclick="openFeedbackModal(${i})"><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"><path d="M1 12s4-8 11-8 11 8 11 8-4 8-11 8S1 12 1 12z"/><circle cx="12" cy="12" r="3"/></svg> View</button></td>
      </tr>`;
  });
